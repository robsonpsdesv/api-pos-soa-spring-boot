package br.com.robson.bibliotecaapi.api.exception;
...
public class BibliotecaExceptionApi extends ResponseEntityExceptionHandler {
    ...
    private List<ErroDetalhe> listarErros(BindingResult bindingResult){
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        List<ErroDetalhe> erros = listarErros (ex.getBindingResult ());
